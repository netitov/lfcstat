...
function LeagueTableRow(props) {
  ...
  // accent position data
  const positionClass = () => {
    if (props.position < 5) return 'table__data table__data_ucl';
    if (props.position === 5) return 'table__data table__data_el';
    if (props.position > 17) return 'table__data table__data_rlg';
    return 'table__data';
  };
  ...
  return (
    ...
    >
      ...
      <td>
        <img src={props.logo} alt="team" className="table__logo" />
      </td>
