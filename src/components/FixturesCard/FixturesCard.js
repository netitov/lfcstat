...
function FixturesCard(props) {
  ...
  /* const resultClass = (props.status !== 'finished') ? ' _inactive'
    : (props.awayScore === props.homeScore) ? ' _draw'
      : (props.awayScore > props.homeScore && props.awayTeamName === mainTeam) ? ' _win'
        : (props.awayScore < props.homeScore && props.homeTeamName === mainTeam) ? ' _win'
          : ' _lose'; */

  const resultClass = () => {
    if (props.status !== 'finished') return ' _inactive';
    if (props.awayScore === props.homeScore) return ' _draw';
    if (props.awayScore > props.homeScore && props.awayTeamName === mainTeam) return ' _win';
    if (props.awayScore < props.homeScore && props.homeTeamName === mainTeam) return ' _win';
    return ' _lose';
  };
  ...
  const leagueLogo = () => {
    if (props.challenge === 'Premier League') return PremierLeague;
    if (props.challenge === 'UEFA Champions League') return Ucl;
    if (props.challenge === 'FA Cup') return FaCupLogo;
    if (props.challenge === 'EFL Cup') return EflLogo;
    return Ball;
  };
  ...
  return (
    <li className="fixtures-card">
      ...
      <div className="fixtures-card__date-container">
        <img src={Calendar} className="fixtures-card__calendar-logo" alt="calendar" />
      ...
      <div className="fixtures-card__container">
        <div className="fixtures-card__team-container fixtures-card__team-container_home">
          ...
          <img src={props.homeTeamLogo} alt="team" className="fixtures-card__logo" />
        </div>
        ...
        <div className="fixtures-card__team-container fixtures-card__team-container_away">
          <img src={props.awayTeamLogo} alt="team" className="fixtures-card__logo" />
          <p className="fixtures-card__team">{props.awayTeamName}</p>
        </div>
      </div>

      <div className="fixtures-card__challenge-container">
        <img src={leagueLogo()} className="fixtures-card__challenge-logo" alt={props.challenge} />
